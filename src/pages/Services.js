    ...
    <div className="page-container">
      ...
      <div className="services-list">
        <div className="service-item">
          <img src="/images/service-webdev.png" alt="Web Development" />
          <h3>Web Development</h3>
          <p>Responsive websites using React, HTML, and CSS.</p>
        </div>
        <div className="service-item">
          <img src="/images/service-mobile.png" alt="Basic Mobile UI" />
          <h3>Basic Mobile UI</h3>
          <p>Mockups and prototype apps using mobile-first design.</p>
        </div>
        <div className="service-item">
          <img src="/images/service-database.png" alt="Database Integration" />
